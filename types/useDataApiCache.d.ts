 ...
 * @property [hasCache] - Allow cache result request
 ...
 * @property [refreshCache = false] - Refresh cache
 */
 ...
 */
declare function useDataApiCache(initialSettings?: initialSettings): [state, fetchData];

export default useDataApiCache;
